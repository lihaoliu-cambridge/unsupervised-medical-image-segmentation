    ...
    while 1:
        ...
        for lpatch in patch_gen:
            ...
            if np.mod(feat_idx, nb_feats) == 0:
                ...
                # add to batch of volume dataloaders, unless the batch is currently empty
                if batch_idx == -1:
...
def ext_data(segpath,
             ...
             expected_nb_files = -1):
    assert ext_data_fields is not None, "Need some external dataloaders fields"

...
def proc_mgh_vols(inpath,
                  ...
                  label_idx=None,
                  **kwargs): 
    ''' process mgh dataloaders from mgz format and save to numpy format
...
def vol_proc(vol_data,
    ...
    # intensity normalize dataloaders .* rescale
